<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="randevuUpdateDelete.aspx.cs" Inherits="Sekreter_Randevu_Sistemi.randevuUpdateDelete" %>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-7">
          <div class="card bg-secondary shadow border-0">
              ...
              <form id="form1" method="post" role="form" runat="server">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <asp:TextBox id="TextBox4" Cssclass="form-control" placeholder="TC Kimlik No" type="text" runat="server"></asp:TextBox>
                  </div>
                </div>
            <br />
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <asp:TextBox id="TextBox5" Cssclass="form-control" placeholder="Adı" type="text" runat="server"></asp:TextBox>
                  </div>
                </div>
            <br />
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <asp:TextBox id="TextBox6" Cssclass="form-control" placeholder="Soyadı" type="text" runat="server"></asp:TextBox>
                  </div>
                </div>
            <br />
                 <div class="form-group mb-3">
                 ...
                 <div class="form-group">
                    <div class="input-group input-group-alternative">
                      <div class="input-group-prepend">
                        ...
                        <asp:TextBox id="TextBox7" Cssclass="form-control" runat="server" placeholder="Tarih seçin!" AutoPostBack="true" OnTextChanged="TextBox7_TextChanged"></asp:TextBox>
                   </div>
                </div>
            <br />
            ...
            <br />
                  <div class="text-center">
                       <button id="Button" type="submit" class="btn btn-warning my-4" runat="server" onserverclick="Button_Click">Güncelle</button>     
                  </div>
             </form>
            </div>
          </div>
