<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkpassword.aspx.cs" Inherits="Sekreter_Randevu_Sistemi.checkpassword1" %>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="randevuSearch.aspx">
              <i class="ni ni ni-world-2 text-orange"></i> Randevu Bul
            </a>
          </li>
        </ul>
                  <!-- Divider -->
